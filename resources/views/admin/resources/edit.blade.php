...
@section('title', 'Modifier Ressource - Admin')
@section('page-title', 'Modifier: ' . $resource->title)
    ...
    <div class="col-lg-10">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0 fw-bold text-secondary">Modifier la ressource</h5>
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $resource->title) }}" required placeholder="Ex: Comment se protéger du cyberharcèlement">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category" name="category" required>
                                    ...
                                    <option value="Cyberharcèlement" {{ old('category', $resource->category) == 'Cyberharcèlement' ? 'selected' : '' }}>Cyberharcèlement</option>
                                    <option value="Harcèlement Scolaire" {{ old('category', $resource->category) == 'Harcèlement Scolaire' ? 'selected' : '' }}>Harcèlement Scolaire</option>
                                    <option value="Harcèlement Sexuel" {{ old('category', $resource->category) == 'Harcèlement Sexuel' ? 'selected' : '' }}>Harcèlement Sexuel</option>
                                    <option value="Guide Juridique" {{ old('category', $resource->category) == 'Guide Juridique' ? 'selected' : '' }}>Guide Juridique</option>
                                    <option value="Autre" {{ old('category', $resource->category) == 'Autre' ? 'selected' : '' }}>Autre</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="summary" name="summary" rows="2" placeholder="Un bref aperçu du contenu...">{{ old('summary', $resource->summary) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="10" required placeholder="Le contenu principal de la ressource...">{{ old('content', $resource->content) }}</textarea>
                            ...
                            <div class="card bg-light border-0 mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" {{ old('is_featured', $resource->is_featured) ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($resource->image_path)
                                            <div class="mb-2">
                                                <img src="{{ asset('storage/' . $resource->image_path) }}" class="img-thumbnail" style="max-height: 100px;">
                                            </div>
                                        @endif
                                        ...
                                        <label for="document_path" class="form-label small fw-bold">Document (PDF/Doc)</label>
                                         @if($resource->document_path)
                                            <div class="mb-2 text-muted small">
                                                <i class="fas fa-paperclip"></i> Fichier actuel présent
                                            </div>
                                        @endif
                                    ...
                                    <div class="mb-3">
                                        <label for="video_path" class="form-label small fw-bold">Vidéo (MP4)</label>
                                          @if($resource->video_path)
                                            <div class="mb-2 text-muted small">
                                                <i class="fas fa-video"></i> Vidéo actuelle présente
                                            </div>
                                        @endif
